    ...
    <div>
      <div className="container section" id='Section4'>
        ...
        <div className='content'>
          ...
          The report also states exposure to pollution from fossil fuels lead to around <span className="bold">49 crore days of work absence</span>.
          <div className='quote red'>Each person in labour force in India take approx. 1 day of work absence on average because of the illness caused by air pollution</div>
